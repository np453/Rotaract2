            ...
            <div className="container d-flex justify-content-center">
                <div class="scene justify-content-center">
                    <div class={this.state.classVal}>
                        <div class="cube__face cube__face--front d-flex align-items-center justify-content-center">
                            <img src={logo} style={{ pointerEvents :"none" }} className="img img-fluid" alt=""/>
                        </div>
